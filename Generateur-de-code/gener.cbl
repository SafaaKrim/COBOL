      ...
      * Déclaration du fichier de sortie qui sera généré.

       DATA DIVISION.
       FILE SECTION.
       FD  FICHIER-GEN.
       01  ENREG-GEN PIC X(80).
      * Définition de la structure de l'enregistrement de fichier.

       WORKING-STORAGE SECTION.
      * Variables pour stocker les choix de la partie PS.
       01  CHOIX-PS.
      ...
      * Variables pour stocker les choix de la partie SGBD.
       01  CHOIX-SGBD.
      ...
      * Variables pour stocker les choix de la partie Sous-routines.
       01  CHOIX-SOUS.
      ...
      * Variables pour stocker les choix de la partie WS.

       01  CHOIX-PROC.
           05 CHOIX-PROC1      PIC 9 VALUE 0.
           05 CHOIX-PROC2      PIC 9 VALUE 0.
      * Variables pour stocker les choix de la partie Procédure.

       SCREEN SECTION.
      * Écran principal pour les choix de la partie PS. 
       01 ECRAN-PRINCIPAL.
           05 LINE 1 COL 1 
      ...
      * Écran principal pour les choix de la partie SGBD.
      ...
      * Écran principal pour les choix de la partie Sous-routines.
      ...
      * Écran principal pour les choix de la partie WS.
      ...
      * Écran principal pour les choix de la partie Procédure.     
       ...
       PROCEDURE DIVISION.
           ...
           STOP RUN.
      * Appel à la procédure principale pour générer l'application.
      * Génération du code basé sur les choix de l'utilisateur.
       GENERER-APPLICATION.
           IF CHOIX-PS1 = 1
           ...
           END-IF.
      * Procédure pour générer le code de lecture d'un fch séquentiel.
       GENERER-LIRE-FICHIER.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'écriture dans un fr séquentiel.
       GENERER-ECRIRE-FICHIER.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code de tri d'un fichier.
       ...
       GENERER-FUSIONNER-FICHIERS.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code de fusion de fichiers.
       ...
       GENERER-ACCEDER-DB.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'accès à une base de données.
       ...
       GENERER-SELECT-COUNT.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code de comptage des enregistrements 
      *dans une base de données.
       ...
       GENERER-CURSEUR.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code de gestion de curseur
      * pour une base de données.
       ...
       GENERER-UPDATE-DB.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code de mise 
      *à jour dans une base de données.
       ...
       GENERER-SOUSROUTINE.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'une sous-routine simple.
       ...
       GENERER-APPEL-SOUSROUTINE.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'appel d'une sous-routine.
       ...
       GENERER-COPYBOOK.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'un Copybook.
       ...
       GENERER-INTEGRER-COPYBOOK.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'intégration d'un Copybook.
       ...
       GENERER-HELLOCobol.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer le code d'affichage d'un message 
      *simple "HELLO, COBOL!".
       ...
       GENERER-PARAGRAPHES-TYPE.
           ...
           WRITE ENREG-GEN
           CLOSE FICHIER-GEN.
      * Procédure pour générer des paragraphes types avec 
      *un affichage de début, de traitement et de fin.
